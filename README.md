...
But, today it's just a set of C++ classes, and nothing is complete. Multi Diag Tools is based on Qt4, but some part of code is platform dependend.
...
To run the unit test suite, you can use make test. All tests are available in tests subdirectory.
...
For each install, the simpliest is to keep default locations, else some work will be needed at next step.
