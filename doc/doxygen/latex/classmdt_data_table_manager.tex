...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000058}{Todo}]NOT implemeted yet !! \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000057}{Todo}]Not used yet. \end{Desc}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000059}{Todo}]Add: separator, data protection, escape char, EOL \end{Desc}
