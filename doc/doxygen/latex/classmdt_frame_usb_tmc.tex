...
\begin{Desc}
\item[\hyperlink{todo__todo000057}{Todo}]Clarify what this class does: USBTMC message or transfer ?\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000056}{Todo}]Check $>$ 0, ... \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000054}{Todo}]Handle error \end{Desc}
