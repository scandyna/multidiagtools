...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{classmdt_frame_usb_tmc_a0b68d661df8b5e5d88594dbff4db511d}{clear} ()
\begin{DoxyCompactList}\small\item\em Clear internal data. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Set message data transfer size. \end{DoxyCompactList}\item 
...
\begin{Desc}
\item[\hyperlink{todo__todo000034}{Todo}]Clarify what this class does: USBTMC message or transfer ?\end{Desc}
...
Usefull for frames received from device. Is only valid when the frame is complete. \hypertarget{classmdt_frame_usb_tmc_a0b68d661df8b5e5d88594dbff4db511d}{
\index{mdtFrameUsbTmc@{mdtFrameUsbTmc}!clear@{clear}}
\index{clear@{clear}!mdtFrameUsbTmc@{mdtFrameUsbTmc}}
\subsubsection[{clear}]{\setlength{\rightskip}{0pt plus 5cm}void mdtFrameUsbTmc::clear (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classmdt_frame_usb_tmc_a0b68d661df8b5e5d88594dbff4db511d}


Clear internal data. 

Calls \hyperlink{classmdt_frame_acdf8a921a3f36ca91af88b55b90febdc}{mdtFrame::clear()} internally after. 
...
Note: \hyperlink{classmdt_frame_usb_tmc_a0b68d661df8b5e5d88594dbff4db511d}{clear()} is called internally. 

Get initial message data size (will be ajusted later whenn add alignment bytes)

\begin{Desc}
\item[\hyperlink{todo__todo000033}{Todo}]Check $>$ 0, ... \end{Desc}
...
If true, this transfer is the last in current message. Is only valid when the frame is complete. \hypertarget{classmdt_frame_usb_tmc_a03d9a1c16099ba7ea1e3a2b0c4e1493e}{
...
Usefull for frames received from device. Is only valid when the frame is complete. \hypertarget{classmdt_frame_usb_tmc_add167ed246e03d6f2ef4e4a9855a9fae}{
...
Usefull for frames received from device. Is only valid when the frame is complete. \hypertarget{classmdt_frame_usb_tmc_a06d2743a113bd2b4cf2ee44014ecd710}{
...
Clear frame's specific flags. 

This method is called from \hyperlink{classmdt_usb_port_thread}{mdtUsbPortThread} and should not be called directly.void \hyperlink{classmdt_frame_ae068ca1ae47516306f5180ffc1712d78}{clearFlags()};
...
\begin{Desc}
\item[\hyperlink{todo__todo000031}{Todo}]Handle error \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000032}{Todo}]other bmTransferAttributes \end{Desc}
...
If true, tells the device that this USBTMC transfer is the last in message. \hypertarget{classmdt_frame_usb_tmc_a7fa61faeaa5d1f5820794c5943b26e26}{
...
To use to build a frame that will be sent to device. \hypertarget{classmdt_frame_usb_tmc_a19121b03cbb4c1bb420dc3cdb132f703}{
...
To use to build a frame that will be sent to device. \hypertarget{classmdt_frame_usb_tmc_a7ad2f8426ebeceaa6f84925d9a96b5c0}{
...
Set message data transfer size. 

Used when send a DEV\_\-DEP\_\-MSG\_\-IN request tell the device the maximum bytes we need to receive. 
