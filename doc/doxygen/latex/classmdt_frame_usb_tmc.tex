...
\begin{Desc}
\item[\hyperlink{todo__todo000048}{Todo}]Clarify what this class does: USBTMC message or transfer ?\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000047}{Todo}]Check $>$ 0, ... \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000045}{Todo}]Handle error \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000046}{Todo}]other bmTransferAttributes \end{Desc}
