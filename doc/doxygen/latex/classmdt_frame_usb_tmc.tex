...
\begin{Desc}
\item[\hyperlink{todo__todo000045}{Todo}]Clarify what this class does: USBTMC message or transfer ?\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000044}{Todo}]Check $>$ 0, ... \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]Handle error \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]other bmTransferAttributes \end{Desc}
