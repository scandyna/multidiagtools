...
\begin{Desc}
\item[\hyperlink{todo__todo000033}{Todo}]Clarify what this class does: USBTMC message or transfer ?\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000032}{Todo}]Check $>$ 0, ... \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000030}{Todo}]Handle error \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000031}{Todo}]other bmTransferAttributes \end{Desc}
