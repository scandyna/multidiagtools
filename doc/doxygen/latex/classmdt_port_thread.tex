...
int \hyperlink{classmdt_port_thread_a25b43b19a0b4a1097f06c69bf5dd9b19}{readFromPort2} (\hyperlink{classmdt_frame}{mdtFrame} $\ast$$\ast$frame)
\begin{DoxyCompactList}\small\item\em Read data from port 2 (new variant to test) \end{DoxyCompactList}\item 
...
Definition at line 364 of file mdtPortThread.cpp.
...
Definition at line 161 of file mdtPortThread.cpp.
...
Reimplemented in \hyperlink{classmdt_port_write_thread_ad2508c3a2433383e2de705e9f3d2e602}{mdtPortWriteThread}.
...
\begin{Desc}
\item[\hyperlink{todo__todo000029}{Todo}]Adapt in threads subclasses \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000026}{Todo}]don't loose the frame !?! \end{Desc}


qDebug() $<$$<$ \char`\"{}mdtPortThread::readFromPort(): frame Null, get new one\char`\"{};

qDebug() $<$$<$ \char`\"{}mdtPortThread::readFromPort(): frame complete, get new one\char`\"{}; 



Definition at line 219 of file mdtPortThread.cpp.

\hypertarget{classmdt_port_thread_a25b43b19a0b4a1097f06c69bf5dd9b19}{
\index{mdtPortThread@{mdtPortThread}!readFromPort2@{readFromPort2}}
\index{readFromPort2@{readFromPort2}!mdtPortThread@{mdtPortThread}}
\subsubsection[{readFromPort2}]{\setlength{\rightskip}{0pt plus 5cm}int mdtPortThread::readFromPort2 (
\begin{DoxyParamCaption}
\item[{{\bf mdtFrame} $\ast$$\ast$}]{frame}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{classmdt_port_thread_a25b43b19a0b4a1097f06c69bf5dd9b19}


Read data from port 2 (new variant to test) 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The number of frames completed during the process. This can be helpful query/reply protocols in witch the standard reply should be one frame. On error, frame is put back into pool and one of the \hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{mdtAbstractPort::error\_\-t} is returned.
\end{DoxyReturn}
\begin{DoxyPrecond}{Precondition}
Port must be set with \hyperlink{classmdt_port_thread_acd51474c3a2683676423317bc9cb31b2}{setPort()} before using this method. 
...
Definition at line 292 of file mdtPortThread.cpp.
...
Definition at line 435 of file mdtPortThread.cpp.
...
Definition at line 371 of file mdtPortThread.cpp.
