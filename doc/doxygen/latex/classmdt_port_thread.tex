...
\hyperlink{classmdt_port_manager}{mdtPortManager} uses this signal. 

Definition at line 107 of file moc\_\-mdtPortThread.cxx.
...
Definition at line 299 of file mdtPortThread.cpp.
...
Definition at line 406 of file mdtPortThread.cpp.

\hypertarget{classmdt_port_thread_a584ee47549b0cb3a9c5de0a1ea496694}{
\index{mdtPortThread@{mdtPortThread}!handleCommonReadErrors@{handleCommonReadErrors}}
\index{handleCommonReadErrors@{handleCommonReadErrors}!mdtPortThread@{mdtPortThread}}
\subsubsection[{handleCommonReadErrors}]{\setlength{\rightskip}{0pt plus 5cm}{\bf mdtAbstractPort::error\_\-t} mdtPortThread::handleCommonReadErrors (
\begin{DoxyParamCaption}
\item[{{\bf mdtAbstractPort::error\_\-t}}]{portError, }
\item[{{\bf mdtFrame} $\ast$$\ast$}]{frame}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{classmdt_port_thread_a584ee47549b0cb3a9c5de0a1ea496694}
...
\begin{DoxyParams}{Parameters}
{\em frame} & Current read frame. Note that another frame can be pointed after a call ofthis method (f.ex. after disconnection) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
port must be set with \hyperlink{classmdt_port_thread_acd51474c3a2683676423317bc9cb31b2}{setPort()}. 
\end{DoxyPrecond}
...
\hypertarget{classmdt_port_thread_a1e775d0d943ef7502ae991918155a756}{
\index{mdtPortThread@{mdtPortThread}!handleCommonReadWriteErrors@{handleCommonReadWriteErrors}}
\index{handleCommonReadWriteErrors@{handleCommonReadWriteErrors}!mdtPortThread@{mdtPortThread}}
\subsubsection[{handleCommonReadWriteErrors}]{\setlength{\rightskip}{0pt plus 5cm}{\bf mdtAbstractPort::error\_\-t} mdtPortThread::handleCommonReadWriteErrors (
\begin{DoxyParamCaption}
\item[{{\bf mdtAbstractPort::error\_\-t}}]{portError, }
\item[{{\bf mdtFrame} $\ast$$\ast$}]{readFrame, }
\item[{{\bf mdtFrame} $\ast$$\ast$}]{writeFrame}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{classmdt_port_thread_a1e775d0d943ef7502ae991918155a756}
...
If readFrame is not null, \hyperlink{classmdt_port_thread_a584ee47549b0cb3a9c5de0a1ea496694}{handleCommonReadErrors()} is called first. If no error was handled, and writeFrame is not null, \hyperlink{classmdt_port_thread_a3ce5b18606f026a8df33ae97a42399b1}{handleCommonWriteErrors()} is called.


\begin{DoxyParams}{Parameters}
{\em readframe} & Current read frame. Note that another frame can be pointed after a call ofthis method (f.ex. after disconnection). \\
\hline
{\em writeFrame} & Current write frame. Note that frame can be null after a call of this method (if a write error occured). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
ErrorHandled if error could be handled or other error (most of cases a UnhandledError). 
...
Definition at line 281 of file mdtPortThread.cpp.

\hypertarget{classmdt_port_thread_a3ce5b18606f026a8df33ae97a42399b1}{
\index{mdtPortThread@{mdtPortThread}!handleCommonWriteErrors@{handleCommonWriteErrors}}
\index{handleCommonWriteErrors@{handleCommonWriteErrors}!mdtPortThread@{mdtPortThread}}
\subsubsection[{handleCommonWriteErrors}]{\setlength{\rightskip}{0pt plus 5cm}{\bf mdtAbstractPort::error\_\-t} mdtPortThread::handleCommonWriteErrors (
\begin{DoxyParamCaption}
\item[{{\bf mdtAbstractPort::error\_\-t}}]{portError, }
\item[{{\bf mdtFrame} $\ast$$\ast$}]{frame}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{classmdt_port_thread_a3ce5b18606f026a8df33ae97a42399b1}
...
\begin{DoxyParams}{Parameters}
{\em frame} & Current write frame. Note that frame will be null after a call of this method. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
ErrorHandled if error could be handled or other error (most of cases a UnhandledError). 
...
Definition at line 243 of file mdtPortThread.cpp.
...
Definition at line 101 of file moc\_\-mdtPortThread.cxx.
...
Definition at line 563 of file mdtPortThread.cpp.
...
pvPort-\/$>$readFramesPool().enqueue($\ast$frame); 



Definition at line 333 of file mdtPortThread.cpp.
...
Definition at line 89 of file moc\_\-mdtPortThread.cxx.

\hypertarget{classmdt_port_thread_abee1d2f9b67ca37cfd13e108ca978b36}{
...
Definition at line 515 of file mdtPortThread.cpp.
...
Definition at line 573 of file mdtPortThread.cpp.
...
Definition at line 423 of file mdtPortThread.cpp.
...
Definition at line 95 of file moc\_\-mdtPortThread.cxx.
...
src/mdtport/mdtPortThread.cpp\item 
src/mdtport/moc\_\-mdtPortThread.cxx\end{DoxyCompactItemize}
