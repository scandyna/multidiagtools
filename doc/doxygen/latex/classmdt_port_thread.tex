...
\begin{DoxyCompactList}\small\item\em Enable/diseable cancel state. \end{DoxyCompactList}\item 
...
Enable/diseable cancel state. 

If cancel state is enabled, the QThread::terminate() will work. Internally, QThread::setTerminationEnabled() is called. See the Qt's QThread documentation for more details.

Subclass notes:\par
 In the run method, this method should be called at first with false parameter, to be shure that thread cannot be cancelled.void setCancelStateEnabled(bool enabled);
...
Reimplemented in \hyperlink{classmdt_tcp_socket_thread_a0fd2b3f8b497427d84ae358c6f72122e}{mdtTcpSocketThread}.
