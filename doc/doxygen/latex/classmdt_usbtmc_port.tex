...
\hypertarget{classmdt_usbtmc_port_a3f9d3f1f40f61e17fa2997f3ad181d30}{
\index{mdtUsbtmcPort@{mdtUsbtmcPort}!$\sim$mdtUsbtmcPort@{$\sim$mdtUsbtmcPort}}
\index{$\sim$mdtUsbtmcPort@{$\sim$mdtUsbtmcPort}!mdtUsbtmcPort@{mdtUsbtmcPort}}
\subsubsection[{$\sim$mdtUsbtmcPort}]{\setlength{\rightskip}{0pt plus 5cm}mdtUsbtmcPort::$\sim$mdtUsbtmcPort (
...
Try to open port pvFd = ::open(pvPortName.toStdString().c\_\-str(), O\_\-RDWR); if(pvFd $<$ 0)\{ err = errno; \hyperlink{classmdt_error}{mdtError} e(MDT\_\-PORT\_\-IO\_\-ERROR, \char`\"{}Unable to open port: \char`\"{} + pvPortName, mdtError::Error); e.setSystemError(err, strerror(err)); MDT\_\-ERROR\_\-SET\_\-SRC(e, \char`\"{}mdtUsbtmcPort\char`\"{}); e.commit(); Check error and return a possibly correct code switch(err)\{ case EACCES: return PortAccess; case ENOENT: return PortNotFound; default: return UnknownError; \} \} Close the port ::close(pvFd); pvFd = -\/1;
...
void \hyperlink{classmdt_abstract_port_a1ace1a2bd1a04f16952980e247b04800}{mdtUsbtmcPort::close()} \{ if(!isOpen())\{ return; \} \hyperlink{classmdt_abstract_port_a6bf2ecdcf894da3929a22eb8793a9fe3}{lockMutex()}; if(pvFd $>$= 0)\{ ::close(pvFd); pvFd = -\/1; \} \hyperlink{classmdt_abstract_port_a1ace1a2bd1a04f16952980e247b04800}{mdtAbstractPort::close()}; \} 
