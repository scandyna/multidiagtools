...
Store the new range and set the value to the minimum. The \hyperlink{classmdt_analog_io_ac36d804e82a4ca9401687700e9e6a136}{valueChanged()} signal is emitted.
...
Store the value and emit \hyperlink{classmdt_analog_io_ac36d804e82a4ca9401687700e9e6a136}{valueChanged()} if new value is different from current.
...
\hline
{\em emitValueChanged} & If true, \hyperlink{classmdt_analog_io_ac36d804e82a4ca9401687700e9e6a136}{valueChanged()} will not be emitted\\
\hline
\end{DoxyParams}
Note for UI developpers:
\begin{DoxyItemize}
...
emit(valueChanged(value)); emit(valueChanged(pvAddress, value)); 
...
Definition at line 238 of file mdtAnalogIo.cpp.
...
The \hyperlink{classmdt_analog_io_ac36d804e82a4ca9401687700e9e6a136}{valueChanged()} signal is emitted.
...
void valueChanged(double newValue); void valueChanged(int address, double newValue);
