...
\hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{error\_\-t} \hyperlink{classmdt_serial_port_ae62fbd70485c30db13c6384c169925c9}{open} ()
\begin{DoxyCompactList}\small\item\em Open the port given by \hyperlink{classmdt_abstract_port_a0ca143d32fc677bac7c1cf0e04144932}{setPortName()} NOTE: \end{DoxyCompactList}\item 
...
\hypertarget{classmdt_serial_port_ae62fbd70485c30db13c6384c169925c9}{
\index{mdtSerialPort@{mdtSerialPort}!open@{open}}
\index{open@{open}!mdtSerialPort@{mdtSerialPort}}
\subsubsection[{open}]{\setlength{\rightskip}{0pt plus 5cm}{\bf mdtAbstractPort::error\_\-t} mdtSerialPort::open (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classmdt_serial_port_ae62fbd70485c30db13c6384c169925c9}


Open the port given by \hyperlink{classmdt_abstract_port_a0ca143d32fc677bac7c1cf0e04144932}{setPortName()} NOTE: 

NOTE:

\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]à supprimer\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000010}{Todo}]A supprimer !! \end{Desc}


Reimplemented from \hyperlink{classmdt_abstract_port_a4e0f0b7f9e24257677184e4bde10fdde}{mdtAbstractPort}.
...
\hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{mdtAbstractPort::error\_\-t} \hyperlink{classmdt_serial_port_ae62fbd70485c30db13c6384c169925c9}{mdtSerialPort::open()} \{ int err;

Close previous opened port \hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{close()};

Try to open port locked O\_\-RDWR : Read/write access O\_\-NOCTTY: not a terminal O\_\-NDELAY: ignore DCD signal pvFd = pvPortLock-\/$>$openLocked(pvPortName, O\_\-RDWR $|$ O\_\-NOCTTY $|$ O\_\-NONBLOCK); if(pvFd $<$ 0)\{ Check if port was locked by another if(pvPortLock-\/$>$isLockedByAnother())\{ \hyperlink{classmdt_error}{mdtError} e(MDT\_\-SERIAL\_\-PORT\_\-IO\_\-ERROR, \char`\"{}Port \char`\"{} + pvPortName + \char`\"{} allready locked, cannot open it\char`\"{}, mdtError::Error); MDT\_\-ERROR\_\-SET\_\-SRC(e, \char`\"{}mdtSerialPort\char`\"{}); e.commit(); return PortLocked; \} err = errno; \hyperlink{classmdt_error}{mdtError} e(MDT\_\-SERIAL\_\-PORT\_\-IO\_\-ERROR, \char`\"{}Unable to open port: \char`\"{} + pvPortName, mdtError::Error); e.setSystemError(err, strerror(err)); MDT\_\-ERROR\_\-SET\_\-SRC(e, \char`\"{}mdtSerialPort\char`\"{}); e.commit(); Check error and return a possibly correct code switch(err)\{ case EACCES: return PortAccess; case ENOENT: return PortNotFound; default: return UnknownError; \} \} Get current config and save it to pvOriginalTermios if(tcgetattr(pvFd, \&pvOriginalTermios) $<$ 0)\{ \hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{close()}; Most of cases, this function fails because the phisical port is not attached return PortNotFound; \} Get current system config on \char`\"{}work copy\char`\"{} if(tcgetattr(pvFd, \&pvTermios) $<$ 0)\{ \hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{close()}; Most of cases, this function fails because the phisical port is not attached return PortNotFound; \}

return \hyperlink{classmdt_abstract_port_a4e0f0b7f9e24257677184e4bde10fdde}{mdtAbstractPort::open()}; \}\begin{Desc}
\item[\hyperlink{todo__todo000011}{Todo}]Split functions and remove this \end{Desc}
bool mdtSerialPort::setAttributes(const QString \&portName) \{ Close previous opened port this-\/$>$\hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{close()}; Clear previous attributes pvAvailableBaudRates.clear(); Try to open port pvFd = ::open(portName.toStdString().c\_\-str(), O\_\-RDONLY $|$ O\_\-NOCTTY $|$ O\_\-NDELAY); if(pvFd $<$ 0)\{ \hyperlink{classmdt_error}{mdtError} e(MDT\_\-UNDEFINED\_\-ERROR, \char`\"{}can not open port '\char`\"{} + portName + \char`\"{}'\char`\"{}, mdtError::Error); e.setSystemError(errno, strerror(errno)); MDT\_\-ERROR\_\-SET\_\-SRC(e, \char`\"{}mdtSerialPort\char`\"{}); e.commit(); pvPortName = \char`\"{}\char`\"{}; return false; \} Set port name pvPortName = portName;

End of attributes, close port ::close(pvFd); return true; \} 

NOTE: adapt to error\_\-t 



Reimplemented from \hyperlink{classmdt_abstract_serial_port_a0bd6de5e10a922d9944376ec5943fd66}{mdtAbstractSerialPort}.
...
The mutex is not handled by this method.void \hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{close()};
...
\end{DoxyReturn}
void \hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{mdtSerialPort::close()} \{ if(!isOpen())\{ return; \} Restore original termios struct tcsetattr(pvFd, TCSANOW, \&pvOriginalTermios); Close the port pvPortLock-\/$>$unlock(); ::close(pvFd); pvFd = -\/1;

\hyperlink{classmdt_abstract_serial_port_ae668910f98ad0e158dc6ebebf0c19805}{mdtAbstractSerialPort::close()}; \} 
...
\begin{Desc}
\item[\hyperlink{todo__todo000012}{Todo}]activate and implement in all subclasses. \end{Desc}
...
\end{DoxyItemize}\hypertarget{classmdt_serial_port_acc51ca593b4592f806ef4b9791486f47}{
