...
\begin{Desc}
\item[\hyperlink{todo__todo000001}{Todo}]Implement UUCP format in LCK.. files \end{Desc}
...
Will remove lockfiles and unlock port with fcntl(). Note: use close() if file is not used later, this is not done by this method. 
