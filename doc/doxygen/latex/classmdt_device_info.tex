...
\begin{Desc}
\item[\hyperlink{todo__todo000020}{Todo}]Conficting with \hyperlink{classmdt_usb_device_descriptor}{mdtUsbDeviceDescriptor} \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000019}{Todo}]Conficting with \hyperlink{classmdt_usb_device_descriptor}{mdtUsbDeviceDescriptor} \end{Desc}
