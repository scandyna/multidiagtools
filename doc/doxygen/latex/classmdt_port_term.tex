...
\hypertarget{classmdt_port_term_aaf0e6b8d2416bf2859fdfd9a851523b8}{
...
\label{classmdt_port_term_aaf0e6b8d2416bf2859fdfd9a851523b8}
...
if(pvCurrentPortManager == 0)\{ qDebug() $<$$<$ \char`\"{}TERM: err, pvCurrentPortManager == 0\char`\"{}; return; \} for(i=0; i$<$pvCurrentPortManager-\/$>$readenFrames().size(); i++)\{ teTerm-\/$>$append(pvCurrentPortManager-\/$>$readenFrames().at(i)); \}



Definition at line 94 of file mdtPortTerm.cpp.
...
Definition at line 149 of file mdtPortTerm.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000050}{Todo}]Error handling ! \end{Desc}
