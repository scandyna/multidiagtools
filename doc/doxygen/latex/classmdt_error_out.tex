...
\begin{DoxyCompactList}\small\item\em Destroy the error output system instance This function must be called from main thread (GUI thread) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Set the dialog display levels mask The mask is a OR combinaison of mdtError::level\_\-t flags. 
...
Set the log levels mask The mask is a OR combinaison of mdtError::level\_\-t flags. 
