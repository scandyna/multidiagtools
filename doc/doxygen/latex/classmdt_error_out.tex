...
\begin{DoxyCompactList}\small\item\em Get the instance of the error output system This function can return a Null pointer if \hyperlink{classmdt_error_out_a9c7f05b03d0f09ff02e8f747bdcd1de7}{init()} was never called. This function, and returned pointer, should be used with care in multi-\/thread applicatopn ! \end{DoxyCompactList}\item 
