...
\item[\hyperlink{deprecated__deprecated000007}{Deprecated}]If no good idea falls in for the usage of number , this constrctor should become obselete . \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Deprecated}
\item[\hyperlink{deprecated__deprecated000008}{Deprecated}]If no good idea falls in for the usage of number , this method should become obselete . \end{DoxyRefDesc}
