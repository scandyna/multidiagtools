...
\begin{DoxyCompactList}\small\item\em Return data that user has selected. \end{DoxyCompactList}\item 
QVariant \hyperlink{classmdt_sql_selection_dialog_aab4943bc01e64f867791c15eea613e23}{selectedData} (int row, const QString \&fieldName)
...
Definition at line 161 of file mdtSqlSelectionDialog.cpp.

\hypertarget{classmdt_sql_selection_dialog_aab4943bc01e64f867791c15eea613e23}{
\index{mdtSqlSelectionDialog@{mdtSqlSelectionDialog}!selectedData@{selectedData}}
\index{selectedData@{selectedData}!mdtSqlSelectionDialog@{mdtSqlSelectionDialog}}
\subsubsection[{selectedData}]{\setlength{\rightskip}{0pt plus 5cm}QVariant mdtSqlSelectionDialog::selectedData (
\begin{DoxyParamCaption}
\item[{int}]{row, }
...
Will return data from selection results that match given row, for given fieldName .

Note that row to give does not match given model's row, but is the row in selection.

This method alos works for multiple rows selection, but is slower than \hyperlink{classmdt_sql_selection_dialog_a85b7c1e3e156c141315d0873fa36d4b3}{selectionResults()} .

If row is out of bound or fieldName not exists, a invalid QVariant is returned. 

Definition at line 207 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 176 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 202 of file mdtSqlSelectionDialog.cpp.

\hypertarget{classmdt_sql_selection_dialog_ad28449f5ab1b3ad4fdbdf3f5a0fbb456}{
\index{mdtSqlSelectionDialog@{mdtSqlSelectionDialog}!selectRows@{selectRows}}
\index{selectRows@{selectRows}!mdtSqlSelectionDialog@{mdtSqlSelectionDialog}}
\subsubsection[{selectRows}]{\setlength{\rightskip}{0pt plus 5cm}void mdtSqlSelectionDialog::selectRows (
\begin{DoxyParamCaption}
\item[{const QString \&}]{fieldName, }
...
Will select rows for witch data in field (designated by fieldName) matches given matchData .
...
Definition at line 126 of file mdtSqlSelectionDialog.cpp.

\hypertarget{classmdt_sql_selection_dialog_a5265f64e773a64f34602ddf9b953821b}{
\index{mdtSqlSelectionDialog@{mdtSqlSelectionDialog}!setAllowEmptyResult@{setAllowEmptyResult}}
\index{setAllowEmptyResult@{setAllowEmptyResult}!mdtSqlSelectionDialog@{mdtSqlSelectionDialog}}
\subsubsection[{setAllowEmptyResult}]{\setlength{\rightskip}{0pt plus 5cm}void mdtSqlSelectionDialog::setAllowEmptyResult (
\begin{DoxyParamCaption}
\item[{bool}]{allow}
\end{DoxyParamCaption}
)}}
...
Definition at line 74 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 113 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 94 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 79 of file mdtSqlSelectionDialog.cpp.
...
Definition at line 150 of file mdtSqlSelectionDialog.cpp.
