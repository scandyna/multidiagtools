...
\begin{Desc}
\item[\hyperlink{todo__todo000017}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
\item[\hyperlink{todo__todo000019}{Todo}]Implement this 
...
}]Unhandled error happen. In this case, thread will stop working. Logfile could give more information, see \hyperlink{classmdt_error}{mdtError} and \hyperlink{classmdt_application}{mdtApplication} \end{description}
\end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
