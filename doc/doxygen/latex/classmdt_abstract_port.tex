...
\begin{Desc}
\item[\hyperlink{todo__todo000016}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
\begin{Desc}
\item[\hyperlink{todo__todo000017}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
