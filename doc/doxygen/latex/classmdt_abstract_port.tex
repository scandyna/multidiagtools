...
\begin{Desc}
\item[\hyperlink{todo__todo000009}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
\begin{Desc}
\item[\hyperlink{todo__todo000010}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000011}{Todo}]adapt subclasses \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]Signal useable ? Note: this method is called from \hyperlink{classmdt_port_read_thread}{mdtPortReadThread} , and should not be used directly\par
...
\begin{Desc}
\item[\hyperlink{todo__todo000014}{Todo}]Signal useable ? Note: this method is called from \hyperlink{classmdt_port_write_thread}{mdtPortWriteThread} , and should not be used directly\par
 Mutex is not handled by this method. \end{Desc}
