...
\begin{Desc}
\item[\hyperlink{todo__todo000009}{Todo}]WaitingCanceled, WriteCanceled, ReadCanceled are not clean defined. The only object that knows when it must stop is the thread itself ! To be a little more clean, thread should check it's running flag each time a function returns a error, and stop if requierd ! \end{Desc}
...
Note for thread implementation:\par
 Some errors must be handled in specific ways depending on port (serial, USB, TCP, ...). Each time a error occurs, thread should check the pvRunning flag, and stop if it is false (typical: after a stop request from main thread, \hyperlink{classmdt_abstract_port}{mdtAbstractPort} subclass will return ReadCanceled, WriteCanceled or ControlCanceled. But it can happen that I/O process was canceled for another reason, this is port specific).

\begin{Desc}
\item[\hyperlink{todo__todo000010}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 

add a DeviceDisconnected (+ adapt in threads) \end{Desc}
\begin{Desc}
\item[Enumerator: ]\par
\begin{description}
...
}]WaitingCanceled, When a thread (\hyperlink{classmdt_port_thread}{mdtPortThread} or subclass) is stopping, it will cancel blocking calls (like \hyperlink{classmdt_abstract_port_aeda364cb191da1038a22dd1fc06a1d49}{waitForReadyRead()} or \hyperlink{classmdt_abstract_port_a35e4686f50e2c53c7e3618cf2c485d92}{waitEventWriteReady()} ). At this case, this error is returned, and the thread knows that it can cleanup and end. Write process was cancelled. The thread should stop the write process, restore the current frame into pool and continue working. \index{ReadCanceled@{ReadCanceled}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!ReadCanceled@{ReadCanceled}}\item[{\em 
...
}]Read process was cancelled. The thread should stop the read process, restore the current frame into pool and continue working. \index{ControlCanceled@{ControlCanceled}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!ControlCanceled@{ControlCanceled}}\item[{\em 
...
}]Read process has timed out. Thread should notify this and continue working. If thread uses the read timeout protocol, no notification should be sent \index{WriteTimeout@{WriteTimeout}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!WriteTimeout@{WriteTimeout}}\item[{\em 
...
}]Write process has timed out. Thread should notify this and continue working. If thread uses the write timeout protocol, no notification should be sent \index{ControlTimeout@{ControlTimeout}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!ControlTimeout@{ControlTimeout}}\item[{\em 
...
}]For USB port: the device is disconnected. For TCP socket: peer has closed the connection. If this error happens, the thread will try to reconnect. If connection fails after maximum trys, a notification is sent with this Disconnected error. \index{Connecting@{Connecting}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!Connecting@{Connecting}}\item[{\em 
...
}]Used to notify portmanager that connection is in progress (see \hyperlink{classmdt_port_thread_a72f5469a7b11ed6c8b4d07af165c4164}{mdtPortThread::reconnect()} ) \index{UnhandledError@{UnhandledError}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!UnhandledError@{UnhandledError}}\item[{\em 
...
}]Write queue is empty. Says that no data can be sent for the moment \end{description}
\end{Desc}



Definition at line 62 of file mdtAbstractPort.h.
...
emit readTimeoutStateChanged(pvReadTimeoutOccured); emit writeTimeoutStateChanged(pvWriteTimeoutOccured); 



Definition at line 26 of file mdtAbstractPort.cpp.
...
Definition at line 44 of file mdtAbstractPort.cpp.
...
Definition at line 367 of file mdtAbstractPort.cpp.
...
Reimplemented in \hyperlink{classmdt_usb_port_a38200f806037e06988e73af246e8a494}{mdtUsbPort}.



Definition at line 335 of file mdtAbstractPort.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000011}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
...
Definition at line 80 of file mdtAbstractPort.cpp.
...
Definition at line 237 of file mdtAbstractPort.cpp.
...
Definition at line 165 of file mdtAbstractPort.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]Thread are to adapt. \end{Desc}


Definition at line 176 of file mdtAbstractPort.cpp.
...
Definition at line 185 of file mdtAbstractPort.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000015}{Todo}]Thread are to adapt. \end{Desc}


Definition at line 196 of file mdtAbstractPort.cpp.
...
Definition at line 344 of file mdtAbstractPort.cpp.
...
qDebug() $<$$<$ \char`\"{}mdtAbstractPort::initQueues() , n: \char`\"{} $<$$<$ \hyperlink{classmdt_abstract_port_a3d105c90696f7c40f29c24fe9b6e4481}{config()}.readQueueSize() $<$$<$ \char`\"{} , fsize: \char`\"{} $<$$<$ \hyperlink{classmdt_abstract_port_a3d105c90696f7c40f29c24fe9b6e4481}{config()}.readFrameSize(); 



Definition at line 253 of file mdtAbstractPort.cpp.
...
Definition at line 63 of file mdtAbstractPort.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]Obselete this ? This method must be implemented in subclass. The pvCancelWrite flag must be set to true if no other system is used to handle the cancel flag (see \hyperlink{classmdt_abstract_port_a35e4686f50e2c53c7e3618cf2c485d92}{waitEventWriteReady()} )\end{Desc}
...
Emited when read timeout state changedvoid readTimeoutStateChanged(bool state);

Emited when write timeout state changedvoid writeTimeoutStateChanged(bool state);
...
Definition at line 325 of file mdtAbstractPort.cpp.
...
Definition at line 330 of file mdtAbstractPort.cpp.
...
Definition at line 227 of file mdtAbstractPort.cpp.
...
Reimplemented in \hyperlink{classmdt_tcp_socket_a6a9990696ea459601b17ddbffe5b0703}{mdtTcpSocket}, and \hyperlink{classmdt_usb_port_af2399348faf1abc20130eab20cfc36ee}{mdtUsbPort}.



Definition at line 137 of file mdtAbstractPort.cpp.
...
Definition at line 160 of file mdtAbstractPort.cpp.
...
Definition at line 48 of file mdtAbstractPort.cpp.
...
Definition at line 114 of file mdtAbstractPort.cpp.
...
Definition at line 155 of file mdtAbstractPort.cpp.
...
This method must be called by system dependant waitEventRead() method. When the read timeout state chages, the signal readTimeoutStateChanged() is emited.\par
\begin{Desc}
\item[\hyperlink{todo__todo000016}{Todo}]Signal useable ? Note: this method is called from \hyperlink{classmdt_port_read_thread}{mdtPortReadThread} , and should not be used directly\par
 Mutex is not handled by this method. \end{Desc}


if(state != pvReadTimeoutOccuredPrevious)\{ /emit readTimeoutStateChanged(state); \} pvReadTimeoutOccuredPrevious = pvReadTimeoutOccured;



Definition at line 205 of file mdtAbstractPort.cpp.

\hypertarget{classmdt_abstract_port_ab51135de1f7bbc4707c3284f924c98dc}{
...
This method must be called by system dependant \hyperlink{classmdt_abstract_port_a35e4686f50e2c53c7e3618cf2c485d92}{waitEventWriteReady()} method When the write timeout state chages, the signal writeTimeoutStateChanged() is emited.\par
\begin{Desc}
\item[\hyperlink{todo__todo000017}{Todo}]Signal useable ? Note: this method is called from \hyperlink{classmdt_port_write_thread}{mdtPortWriteThread} , and should not be used directly\par
 Mutex is not handled by this method. \end{Desc}


if(state != pvWriteTimeoutOccured)\{ /emit writeTimeoutStateChanged(state); \} pvWriteTimeoutOccuredPrevious = pvWriteTimeoutOccured;



Definition at line 216 of file mdtAbstractPort.cpp.
...
Subclass notes:\par
 This method must be re-\/implemented in subclass. The write timeout state must be updated with \hyperlink{classmdt_abstract_port_ab51135de1f7bbc4707c3284f924c98dc}{updateWriteTimeoutState()} Notes about mutex handling:
\begin{DoxyItemize}
...
Definition at line 142 of file mdtAbstractPort.cpp.
...
Definition at line 372 of file mdtAbstractPort.cpp.
...
Definition at line 377 of file mdtAbstractPort.cpp.
...
Definition at line 232 of file mdtAbstractPort.cpp.



\subsection{Member Data Documentation}
\hypertarget{classmdt_abstract_port_a412c3e4903bf7d90914cfeb273e82623}{
\index{mdtAbstractPort@{mdtAbstractPort}!pvReadenFrames@{pvReadenFrames}}
\index{pvReadenFrames@{pvReadenFrames}!mdtAbstractPort@{mdtAbstractPort}}
\subsubsection[{pvReadenFrames}]{\setlength{\rightskip}{0pt plus 5cm}QQueue$<${\bf mdtFrame}$\ast$$>$ {\bf mdtAbstractPort::pvReadenFrames}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
\label{classmdt_abstract_port_a412c3e4903bf7d90914cfeb273e82623}
bool pvWriteTimeoutOccuredPrevious; bool pvCancelWrite; // Updated by \hyperlink{classmdt_abstract_port_a1667fa938d3a7578b73f54c32015c369}{pvFlushOut()} and \hyperlink{classmdt_abstract_port_a9a69eb2fc07d551ab37c011487fa319d}{addFrameToWrite()} 

Definition at line 626 of file mdtAbstractPort.h.
