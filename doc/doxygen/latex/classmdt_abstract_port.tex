...
\begin{Desc}
\item[\hyperlink{todo__todo000004}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
The mutex is locked internally, and should not be locked before calling this method. The mutex is unlocked before returning.
...
\begin{Desc}
\item[\hyperlink{todo__todo000005}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
...
Reimplemented in \hyperlink{classmdt_usb_port_a3bffadb42f159b04225b95c6aa7fbf29}{mdtUsbPort}.
...
Reimplemented in \hyperlink{classmdt_port_a42022f9fe08166418711b956c6aabb49}{mdtPort}, and \hyperlink{classmdt_usb_port_ad17584feba55650ed580cf54e2ced99e}{mdtUsbPort}.
