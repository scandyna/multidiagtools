...
virtual \hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{error\_\-t} \hyperlink{classmdt_abstract_port_a44d2d57b118d2b1f7a0041fcf84958ac}{tryOpen} ()=0
...
}]Port cannot be open with requierd access (read, write) \index{UnknownError@{UnknownError}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!UnknownError@{UnknownError}}\item[{\em 
...
Reimplemented in \hyperlink{classmdt_port_aa494585a96a16c80a04dd32b0b6a0d4c}{mdtPort}, \hyperlink{classmdt_usbtmc_port_a6fec5e49a42e6c2e6202a8b2f7f0dc37}{mdtUsbtmcPort}, \hyperlink{classmdt_tcp_socket_a7fd4aec4bc5e3e17034f0ec6647af1e8}{mdtTcpSocket}, and \hyperlink{classmdt_serial_port_a9ce6490af9ecba3bbc8a8e7de44c3f95}{mdtSerialPort}.
...
{\em portName} & Name of the port to open (f.ex: /dev/ttyS0 , COM1, ...)virtual bool setAttributes(const QString \&portName) = 0;\\
\hline
\end{DoxyParams}
Open the port
...
\item Call this open method (with \hyperlink{classmdt_abstract_port_a4a8195c2bf580eb69ad5d90de86798e6}{mdtAbstractPort::open()} ). At this last step, the queues will be initialized, mutex unocked and open flag updated.
\end{DoxyItemize}
...
Reimplemented in \hyperlink{classmdt_port_ac7158d1d718dbc6068648bbed1eab747}{mdtPort}, \hyperlink{classmdt_usbtmc_port_acf677164611ea563e40be93e1b36236a}{mdtUsbtmcPort}, and \hyperlink{classmdt_tcp_socket_aca164cd2f0b47988291afb7fbb423648}{mdtTcpSocket}.
...
\hypertarget{classmdt_abstract_port_a44d2d57b118d2b1f7a0041fcf84958ac}{
\index{mdtAbstractPort@{mdtAbstractPort}!tryOpen@{tryOpen}}
\index{tryOpen@{tryOpen}!mdtAbstractPort@{mdtAbstractPort}}
\subsubsection[{tryOpen}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf error\_\-t} mdtAbstractPort::tryOpen (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}
\label{classmdt_abstract_port_a44d2d57b118d2b1f7a0041fcf84958ac}


TODO: 

\begin{Desc}
\item[\hyperlink{todo__todo000007}{Todo}]activate and implement in all subclasses. \end{Desc}
...
Implemented in \hyperlink{classmdt_port_ad3c958b5559e39ed8bb6b0c699809755}{mdtPort}, \hyperlink{classmdt_usbtmc_port_a400c209a895be62c2554db395a9864d4}{mdtUsbtmcPort}, \hyperlink{classmdt_tcp_socket_af151666d97ee2547297ff836430893ce}{mdtTcpSocket}, and \hyperlink{classmdt_serial_port_a75750b52566e8448ee2eef649903fdb0}{mdtSerialPort}.
