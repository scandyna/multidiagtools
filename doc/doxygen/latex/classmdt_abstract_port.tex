...
\begin{Desc}
\item[\hyperlink{todo__todo000006}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
\item[\hyperlink{todo__todo000008}{Todo}]Implement this 
...
\begin{Desc}
\item[\hyperlink{todo__todo000007}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
