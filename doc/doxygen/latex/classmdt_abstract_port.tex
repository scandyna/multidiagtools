...
Close port if it is open. The mutex is not handled by this method.

Subclass notes:\par
 Internally, this method calls \hyperlink{classmdt_abstract_port_add29e91ccc4be62ab5c0dcb2a68ae8f0}{pvClose()}. Once done, the flags are updated \begin{Desc}
\item[\hyperlink{todo__todo000009}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
...
\item The \hyperlink{classmdt_error}{mdtError} system should be used (on error) to keep trace in logfile.virtual error\_\-t tryOpen() = 0;
\end{DoxyItemize}
...
Reimplemented in \hyperlink{classmdt_serial_port_ae62fbd70485c30db13c6384c169925c9}{mdtSerialPort}.
