...
\hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85ea0ad63405c52aec71c554990aaaa98b79}{WriteQueueEmpty}
 \}
...
\begin{Desc}
\item[\hyperlink{todo__todo000012}{Todo}]add UnhandledError to complete UnknownError (+ adapt in threads) 
...
}]Read process was cancelled. The thread should stop the write process, restore the current frame into pool and continue working. \index{Disconnected@{Disconnected}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!Disconnected@{Disconnected}}\item[{\em 
...
}]Used to notify portmanager that connection is in progress (see \hyperlink{classmdt_port_thread_a72f5469a7b11ed6c8b4d07af165c4164}{mdtPortThread::reconnect()} ) \index{UnknownError@{UnknownError}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!UnknownError@{UnknownError}}\item[{\em 
...
}]Unknown error is happen. Logfile could give more information, see \hyperlink{classmdt_error}{mdtError} and \hyperlink{classmdt_application}{mdtApplication} \index{UnhandledError@{UnhandledError}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!UnhandledError@{UnhandledError}}\item[{\em 
...
}]Read frames pool is empty. Says that no data can be received for the moment \index{WriteQueueEmpty@{WriteQueueEmpty}!mdtAbstractPort@{mdtAbstractPort}}\index{mdtAbstractPort@{mdtAbstractPort}!WriteQueueEmpty@{WriteQueueEmpty}}\item[{\em 
\hypertarget{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85ea0ad63405c52aec71c554990aaaa98b79}{
WriteQueueEmpty}
\label{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85ea0ad63405c52aec71c554990aaaa98b79}
...
Definition at line 333 of file mdtAbstractPort.cpp.
...
frame must be a vail pointer. 
\end{DoxyPrecond}


Definition at line 307 of file mdtAbstractPort.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]Actuellement, les queues sont deletée ici, que faire ? \end{Desc}
...
Definition at line 211 of file mdtAbstractPort.cpp.
...
Definition at line 316 of file mdtAbstractPort.cpp.
...
Definition at line 225 of file mdtAbstractPort.cpp.
...
Definition at line 297 of file mdtAbstractPort.cpp.
...
Definition at line 302 of file mdtAbstractPort.cpp.
...
This method must be called by system dependant \hyperlink{classmdt_abstract_port_a35e4686f50e2c53c7e3618cf2c485d92}{waitEventWriteReady()} method When the write timeout state chages, the signal \hyperlink{classmdt_abstract_port_abd4a3e5738ac13167ddaafe95926ce4d}{writeTimeoutStateChanged()} is emited.\par
...
Implemented in \hyperlink{classmdt_port_a85e77a391f6f5782428beb2e6aee52f8}{mdtPort}, \hyperlink{classmdt_usbtmc_port_a24cfc5233e09b9dbcdb2adc5f700dc4a}{mdtUsbtmcPort}, \hyperlink{classmdt_tcp_socket_a33385bcde41b8065ea7eff65c754b0cb}{mdtTcpSocket}, \hyperlink{classmdt_usb_port_a3be875f6f10ae94fd3a94f925bb935e7}{mdtUsbPort}, and \hyperlink{classmdt_serial_port_a988825b3ff2ef93a1b43e2df316055bd}{mdtSerialPort}.
...
Implemented in \hyperlink{classmdt_port_a84594fdb56cd455a366c69b0a9228020}{mdtPort}, \hyperlink{classmdt_usbtmc_port_a3c1b746acfc06857eee4b4c136cd65ad}{mdtUsbtmcPort}, \hyperlink{classmdt_tcp_socket_adb09186cdacdac15291523c59f156cd4}{mdtTcpSocket}, \hyperlink{classmdt_usb_port_ab8ddd4ebee603ac381e8da0383a61e36}{mdtUsbPort}, and \hyperlink{classmdt_serial_port_ad150a45c68d98a501bea2f102aeadb50}{mdtSerialPort}.
...
Implemented in \hyperlink{classmdt_port_a62f4a6f2c547d40d3743ce893e0f64d6}{mdtPort}, \hyperlink{classmdt_usbtmc_port_a32b98d2a61617293c328a343d62d52c3}{mdtUsbtmcPort}, \hyperlink{classmdt_tcp_socket_adbf2db44b291127a499d9f8720beb632}{mdtTcpSocket}, \hyperlink{classmdt_usb_port_af81c0fc2955ed2778ccdf6c7206f2b16}{mdtUsbPort}, and \hyperlink{classmdt_serial_port_a282f99035c032fbb6fa86ccd10deb597}{mdtSerialPort}.
...
Definition at line 338 of file mdtAbstractPort.cpp.
...
Definition at line 343 of file mdtAbstractPort.cpp.
...
Definition at line 206 of file mdtAbstractPort.cpp.
