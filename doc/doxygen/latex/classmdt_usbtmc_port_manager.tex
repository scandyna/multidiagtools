...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]Finish and test \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]Implement clear halt \end{Desc}




Definition at line 268 of file mdtUsbtmcPortManager.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]On complete frame, check bTag/bTagInverse, and INITIATE\_\-CLEAR on error. \end{Desc}
...
Definition at line 430 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 398 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 367 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 103 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 182 of file mdtUsbtmcPortManager.cpp.
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000044}{Todo}]SigName is emited. In blocking mode, data must (additionally) be enqueued until there are readen. So, for blocking mode (\char`\"{}script\char`\"{}), set this parameter true. \end{Desc}
\begin{DoxyReturn}{Returns}
bTag ID on success or value $<$ 0 if write queue is full. 
\end{DoxyReturn}


Definition at line 223 of file mdtUsbtmcPortManager.cpp.
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000040}{Todo}]finish ! \end{Desc}
...
Definition at line 235 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 145 of file mdtUsbtmcPortManager.cpp.
