...
\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]On complete frame, check bTag/bTagInverse, and INITIATE\_\-CLEAR on error. $<$-\/ Should be done in thread.. \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]Check ID coherence ? Should be a assertion ? \end{Desc}
...
Definition at line 275 of file mdtUsbtmcPortManager.cpp.
...
Will wait until it's possible to write. See \hyperlink{classmdt_usbtmc_port_manager_a6d566c68ddeb7c7ca14b5c70ae784efc}{sendData()} and \hyperlink{classmdt_usbtmc_port_manager_a2920bdd6b189f198f132de9e5555a78b}{sendReadRequest()} for details (used internally).
...
Definition at line 184 of file mdtUsbtmcPortManager.cpp.
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]finish ! \end{Desc}
