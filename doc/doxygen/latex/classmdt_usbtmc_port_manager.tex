...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000039}{Todo}]Finish and test \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000040}{Todo}]Implement clear halt \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]On complete frame, check bTag/bTagInverse, and INITIATE\_\-CLEAR on error. \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]Check ID coherence ? Should be a assertion ? \end{Desc}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000037}{Todo}]Remove timeouts \end{Desc}
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]SigName is emited. In blocking mode, data must (additionally) be enqueued until there are readen. So, for blocking mode (\char`\"{}script\char`\"{}), set this parameter true. \end{Desc}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000038}{Todo}]finish ! \end{Desc}
