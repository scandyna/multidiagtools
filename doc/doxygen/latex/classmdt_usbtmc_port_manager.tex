...
Definition at line 52 of file mdtUsbtmcPortManager.cpp.



\subsection{Member Function Documentation}
\hypertarget{classmdt_usbtmc_port_manager_ae845b25c292e83ef9fe01640867c7116}{
\index{mdtUsbtmcPortManager@{mdtUsbtmcPortManager}!abortBulkIn@{abortBulkIn}}
\index{abortBulkIn@{abortBulkIn}!mdtUsbtmcPortManager@{mdtUsbtmcPortManager}}
\subsubsection[{abortBulkIn}]{\setlength{\rightskip}{0pt plus 5cm}int mdtUsbtmcPortManager::abortBulkIn (
\begin{DoxyParamCaption}
\item[{quint8}]{bTag}
\end{DoxyParamCaption}
)}}
\label{classmdt_usbtmc_port_manager_ae845b25c292e83ef9fe01640867c7116}
...
qDebug() $<$$<$ \char`\"{}$\ast$-\/$\ast$ send INITIATE\_\-ABORT\_\-BULK\_\-IN ...\char`\"{};

qDebug() $<$$<$ \char`\"{}$\ast$-\/$\ast$ send CHECK\_\-ABORT\_\-BULK\_\-IN\_\-STATUS ...\char`\"{}; 



Definition at line 252 of file mdtUsbtmcPortManager.cpp.
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000046}{Todo}]Finish and test \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000047}{Todo}]Implement clear halt \end{Desc}




Definition at line 424 of file mdtUsbtmcPortManager.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000048}{Todo}]On complete frame, check bTag/bTagInverse, and INITIATE\_\-CLEAR on error. \end{Desc}
...
Definition at line 586 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 56 of file mdtUsbtmcPortManager.cpp.

\hypertarget{classmdt_usbtmc_port_manager_a24350448e3b021360f6afb5f1bfba877}{
\index{mdtUsbtmcPortManager@{mdtUsbtmcPortManager}!sendCheckAbortBulkInStatusRequest@{sendCheckAbortBulkInStatusRequest}}
\index{sendCheckAbortBulkInStatusRequest@{sendCheckAbortBulkInStatusRequest}!mdtUsbtmcPortManager@{mdtUsbtmcPortManager}}
\subsubsection[{sendCheckAbortBulkInStatusRequest}]{\setlength{\rightskip}{0pt plus 5cm}int mdtUsbtmcPortManager::sendCheckAbortBulkInStatusRequest (
\begin{DoxyParamCaption}
\item[{quint8}]{bTag}
\end{DoxyParamCaption}
)}}
\label{classmdt_usbtmc_port_manager_a24350448e3b021360f6afb5f1bfba877}


Send a CHECK\_\-ABORT\_\-BULK\_\-IN\_\-STATUS request thru the control endpoint. 

\begin{DoxySeeAlso}{See also}
\hyperlink{classmdt_usbtmc_port_manager_ae845b25c292e83ef9fe01640867c7116}{abortBulkIn()} 
\end{DoxySeeAlso}
\begin{DoxyReturn}{Returns}
...
Definition at line 392 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 554 of file mdtUsbtmcPortManager.cpp.
...
\hline
{\em timeout} & Write timeout \mbox{[}ms\mbox{]} If 0, internal defined timeout is used (see \hyperlink{classmdt_port_manager_a7cb3155940e23db0122d14f21fca858d}{mdtPortManager::adjustedReadTimeout()} for details). \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Definition at line 83 of file mdtUsbtmcPortManager.cpp.

\hypertarget{classmdt_usbtmc_port_manager_ad52e35820d576a9dba9dc33feacb0202}{
\index{mdtUsbtmcPortManager@{mdtUsbtmcPortManager}!sendInitiateAbortBulkInRequest@{sendInitiateAbortBulkInRequest}}
\index{sendInitiateAbortBulkInRequest@{sendInitiateAbortBulkInRequest}!mdtUsbtmcPortManager@{mdtUsbtmcPortManager}}
\subsubsection[{sendInitiateAbortBulkInRequest}]{\setlength{\rightskip}{0pt plus 5cm}int mdtUsbtmcPortManager::sendInitiateAbortBulkInRequest (
\begin{DoxyParamCaption}
\item[{quint8}]{bTag}
\end{DoxyParamCaption}
)}}
\label{classmdt_usbtmc_port_manager_ad52e35820d576a9dba9dc33feacb0202}


Send a INITIATE\_\-ABORT\_\-BULK\_\-IN request thru the control endpoint. 
...
Definition at line 361 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 523 of file mdtUsbtmcPortManager.cpp.
...
transaction-\/$>$setType(MDT\_\-FC\_\-SCPI\_\-UNKNOW);

qDebug() $<$$<$ \char`\"{}mdtUsbtmcPortManager::sendQuery() , bTag: \char`\"{} $<$$<$ bTag $<$$<$ \char`\"{} , query: \char`\"{} $<$$<$ query; 
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000049}{Todo}]SigName is emited. In blocking mode, data must (additionally) be enqueued until there are readen. So, for blocking mode (\char`\"{}script\char`\"{}), set this parameter true. \end{Desc}
\begin{DoxyReturn}{Returns}
bTag ID on success or value $<$ 0 if write queue is full. 
\end{DoxyReturn}


Definition at line 208 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 167 of file mdtUsbtmcPortManager.cpp.
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000045}{Todo}]finish ! \end{Desc}
...
Definition at line 220 of file mdtUsbtmcPortManager.cpp.
...
Definition at line 130 of file mdtUsbtmcPortManager.cpp.
