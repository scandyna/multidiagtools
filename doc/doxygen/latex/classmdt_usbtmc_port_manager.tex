...
\subsubsection[{scan}]{\setlength{\rightskip}{0pt plus 5cm}QStringList mdtUsbtmcPortManager::scan (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
if(port-\/$>$setAttributes(portNames.at(i)))\{ availablePorts.append(portNames.at(i)); \}
