...
\item 
void \hyperlink{classmdt_tcp_socket_thread_ad288905cfcb60ed16643890bafa8b9f0}{newFrameReaden} ()
\begin{DoxyCompactList}\small\item\em New frame was readen. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\index{mdtTcpSocketThread@{mdtTcpSocketThread}!newFrameReaden@{newFrameReaden}}
\index{newFrameReaden@{newFrameReaden}!mdtTcpSocketThread@{mdtTcpSocketThread}}
\subsubsection[{newFrameReaden}]{\setlength{\rightskip}{0pt plus 5cm}void mdtTcpSocketThread::newFrameReaden (
...
New frame was readen. 

This signal is emitted when a new frame was readen. The frame can be complete or not (depending of the EOF condition) \begin{DoxySeeAlso}{See also}
...
src/mdtport/mdtTcpSocketThread.cpp\item 
src/mdtport/moc\_\-mdtTcpSocketThread.cxx\end{DoxyCompactItemize}
