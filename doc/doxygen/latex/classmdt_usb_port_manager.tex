...
bool \hyperlink{classmdt_usb_port_manager_ac82266ba23d2a01729df927906d76556}{waitReadenControlResponse} (int timeout=500)
...
\begin{DoxyCompactList}\small\item\em Get all readen control responses. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Will create \hyperlink{classmdt_usb_port}{mdtUsbPort} and \hyperlink{classmdt_usb_port_thread}{mdtUsbPortThread} objects. 
...
Definition at line 52 of file mdtUsbPortManager.cpp.
...
Definition at line 262 of file mdtUsbPortManager.cpp.
...
Definition at line 65 of file mdtUsbPortManager.cpp.
...
Definition at line 199 of file mdtUsbPortManager.cpp.

\hypertarget{classmdt_usb_port_manager_a9bdfe328351a532f193f3f0a25caeaa9}{
\index{mdtUsbPortManager@{mdtUsbPortManager}!sendSingleReadTransferRequest@{sendSingleReadTransferRequest}}
\index{sendSingleReadTransferRequest@{sendSingleReadTransferRequest}!mdtUsbPortManager@{mdtUsbPortManager}}
\subsubsection[{sendSingleReadTransferRequest}]{\setlength{\rightskip}{0pt plus 5cm}void mdtUsbPortManager::sendSingleReadTransferRequest (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classmdt_usb_port_manager_a9bdfe328351a532f193f3f0a25caeaa9}


Request port to process one read transfer. 

This is, for example, used by USBTMC bulk in abort process. If such request is pending, thread will do a single read transfer. 

port-\/$>$setSingleReadTransferRequest(); 



Definition at line 183 of file mdtUsbPortManager.cpp.

\hypertarget{classmdt_usb_port_manager_ac82266ba23d2a01729df927906d76556}{
...
\label{classmdt_usb_port_manager_ac82266ba23d2a01729df927906d76556}
