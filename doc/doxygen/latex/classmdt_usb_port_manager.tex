...
Definition at line 320 of file mdtUsbPortManager.cpp.
...
Definition at line 327 of file mdtUsbPortManager.cpp.
...
This implementation will handle some USB specific errors, change the current state emiting transistion signal. If state has changed, \hyperlink{classmdt_port_manager_a1c9e1848373831962b7ec83fd4fe5d35}{stateChanged()} signal is emited.
...
Definition at line 372 of file mdtUsbPortManager.cpp.
...
Definition at line 299 of file mdtUsbPortManager.cpp.
...
Definition at line 210 of file mdtUsbPortManager.cpp.
...
Definition at line 232 of file mdtUsbPortManager.cpp.
...
Internally, \hyperlink{classmdt_port_manager_aab594613e8985590c835194efbc27b5e}{mdtPortManager::openPort()} is called.bool \hyperlink{classmdt_port_manager_aab594613e8985590c835194efbc27b5e}{openPort()};
...
bool \hyperlink{classmdt_port_manager_aab594613e8985590c835194efbc27b5e}{mdtUsbPortManager::openPort()} \{ \hyperlink{classmdt_usb_port_thread}{mdtUsbPortThread} $\ast$portThread;

if(pvThreads.size() $<$ 0)\{ portThread = new \hyperlink{classmdt_usb_port_thread}{mdtUsbPortThread}; connect(portThread, SIGNAL(controlResponseReaden()), this, SLOT(\hyperlink{classmdt_usb_port_manager_af043c75c74665b23d13f3cb73150935c}{fromThreadControlResponseReaden()})); /connect(portThread, SIGNAL(messageInReaden()), this, SLOT(\hyperlink{classmdt_usb_port_manager_a9b7154590a4eb267aff4e11ba53dd7aa}{fromThreadMessageInReaden()})); /connect(portThread, SIGNAL(readUntilShortPacketReceivedFinished()), this, SLOT(\hyperlink{classmdt_usb_port_manager_a8f53dc5445b7f8f4a077f3cc25880b5d}{fromThreadReadUntilShortPacketReceivedFinished()})); addThread(portThread); \}

return \hyperlink{classmdt_port_manager_aab594613e8985590c835194efbc27b5e}{mdtPortManager::openPort()}; \} 
...
Definition at line 195 of file mdtUsbPortManager.cpp.
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000036}{Todo}]Adapt using internal timeouts + errors system \end{Desc}
...
Definition at line 270 of file mdtUsbPortManager.cpp.
