...
\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]Error on incomplete frame \end{Desc}
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000019}{Todo}]Should return transactionId , or $<$ 0 on error \end{Desc}
