...
\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]Error on incomplete frame \end{Desc}
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000014}{Todo}]Should return transactionId , or $<$ 0 on error \end{Desc}


frame-\/$>$setWaitAnAnswer(false);

\begin{Desc}
\item[\hyperlink{todo__todo000012}{Todo}]Handle this ? \end{Desc}
