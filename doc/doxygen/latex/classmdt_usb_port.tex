...
\begin{Desc}
\item[\hyperlink{todo__todo000032}{Todo}]Note about \hyperlink{classmdt_abstract_port_a0ca143d32fc677bac7c1cf0e04144932}{setPortName()} with vid:pid syntax \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000016}{Todo}]Echanger fin et début transfert (sinon ne se fait pas de suite...) \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000017}{Todo}]Could be done once by setup ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000018}{Todo}]Handle retval \end{Desc}
...
\hyperlink{structmdt__usb__port__transfer__data}{mdt\_\-usb\_\-port\_\-transfer\_\-data} $\ast$data = (mdt\_\-usb\_\-port\_\-transfer\_\-data$\ast$)transfer-\/$>$user\_\-data; Q\_\-ASSERT(data != 0); data-\/$>$flag1 = transfer-\/$>$status;
...
\begin{Desc}
\item[\hyperlink{todo__todo000019}{Todo}]: Update timeout states ! \end{Desc}


NOTE: provisoire !!

NOTE:\begin{Desc}
\item[\hyperlink{todo__todo000020}{Todo}]timeout ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000021}{Todo}]abort events ?? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000022}{Todo}]: timeout ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000023}{Todo}]can be because device was deconnected, handle this.. \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000024}{Todo}]Should not be the events locked ?? \end{Desc}


libusb\_\-unlock\_\-events(pvLibusbContext);

\begin{Desc}
\item[\hyperlink{todo__todo000025}{Todo}]: timeouts ? \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000009}{Todo}]: Update timeout states ! \end{Desc}


NOTE: provisoire !!

NOTE:\begin{Desc}
\item[\hyperlink{todo__todo000010}{Todo}]timeout ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000011}{Todo}]abort events ?? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000012}{Todo}]: timeout ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000013}{Todo}]can be because device was deconnected, handle this.. \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000014}{Todo}]Should not be the events locked ?? \end{Desc}


libusb\_\-unlock\_\-events(pvLibusbContext);

\begin{Desc}
\item[\hyperlink{todo__todo000015}{Todo}]: timeouts ? \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000026}{Todo}]Could be done once by setup ? \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000027}{Todo}]Handle retval \end{Desc}
