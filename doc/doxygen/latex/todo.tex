...
\begin{DoxyDescription}
\item[Member \hyperlink{classmdt_device_status_widget_af9d0bf5fb74e55bcdab7c8bd86ddfa33}{mdtDeviceStatusWidget::setState}(int state, const QString \&message, const QString \&details) ]Implement details 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classmdt_port_thread_a8756fe2a26bf267376b4003a2896ff48}{mdtPortThread::readFromPort}(\hyperlink{classmdt_frame}{mdtFrame} $\ast$$\ast$frame, bool emitNewFrameReaden=true) ]Handle timeout error ? 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classmdt_usb_port_a9f4f09dac3f09b1766072cd9c1292ab1}{mdtUsbPort::addbTagToAbort}(quint8 bTag) ]Obselete All pending bTags queued will be aborted regarding USBTMC standard (INITIATE/CHECK ABORT\_\-BULK\_\-IN)
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classmdt_usb_port_a551748422808cbb071930e1134bfaad5}{mdtUsbPort::handleUsbEvents}(struct timeval $\ast$timeout, quint8 endpoint) ]Think that timeout has no sense here, should be filtered 
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Member \hyperlink{classmdt_usb_port_a43e3102b004f213ecc01b17f31607957}{mdtUsbPort::takebTagToAbort}() ]Obselete This method is used by USB thread, and should not be used else.
\end{DoxyDescription}
...
\begin{DoxyDescription}
\item[Class \hyperlink{classmdt_usbtmc_port_manager}{mdtUsbtmcPortManager} ]Write a USBTMC port thread 
\end{DoxyDescription}
