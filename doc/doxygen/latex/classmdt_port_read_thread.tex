...
\end{DoxySeeAlso}
\begin{Desc}
\item[\hyperlink{todo__todo000032}{Todo}]suspendTransmission() call is no longer in \hyperlink{classmdt_port_thread_a611211e56620ec9c699019452716e4fc}{getNewFrameRead()}, must be handled in run() now. \end{Desc}
