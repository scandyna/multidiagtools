...
\hyperlink{classmdt_serial_port_config}{mdtSerialPortConfig} $\ast$config = dynamic\_\-cast$<$mdtSerialPortConfig$\ast$$>$(pvConfig); Q\_\-ASSERT(config != 0); return $\ast$config; 
...
\hyperlink{classmdt_serial_port_config}{mdtSerialPortConfig} $\ast$c = dynamic\_\-cast$<$mdtSerialPortConfig$\ast$$>$(pvConfig); Q\_\-ASSERT(c != 0);
