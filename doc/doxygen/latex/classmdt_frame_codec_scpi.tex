...
When decode was done, the values are available with \hyperlink{classmdt_frame_codec_scpi_a86fc76aea879f706f511792b4add5efe}{values()} \hypertarget{classmdt_frame_codec_scpi_ada41abe80ecd27b4cc4f18bb96560753}{
...
When decode was done, the values are available with \hyperlink{classmdt_frame_codec_scpi_a86fc76aea879f706f511792b4add5efe}{values()} \hypertarget{classmdt_frame_codec_scpi_a327afabbb6da25e31523ef4baa28cc87}{
...
This method returns a QVariant. QVariant's internal data is converted to int. If value is not valid, the QVariant is cleared, so it is possible to check this with QVariant::isValid(). When decode was done, the values are available with \hyperlink{classmdt_frame_codec_scpi_a86fc76aea879f706f511792b4add5efe}{values()} 
