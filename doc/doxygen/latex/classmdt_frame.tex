...
}]MODBUS/TCP frame type \end{description}
\end{Desc}
...
Bytes to store can be the \hyperlink{classmdt_frame_aa1cd5c914c36efb3f441b7f6e782dc24}{remainCapacity()} value if frame is not full and EOF condition was not reached. Else, it returns 0. \hypertarget{classmdt_frame_acdf8a921a3f36ca91af88b55b90febdc}{
...
Internally, it calls QByteArray's \hyperlink{classmdt_frame_acdf8a921a3f36ca91af88b55b90febdc}{clear()} and reserve() functions. The goal is to keep the same capacity and reset some \hyperlink{classmdt_frame}{mdtFrame} specific flags 

Reimplemented in \hyperlink{classmdt_frame_modbus_tcp_a622fd5104f4e91a96621e6b5e0f4f89f}{mdtFrameModbusTcp}, and \hyperlink{classmdt_frame_usb_tmc_a0b68d661df8b5e5d88594dbff4db511d}{mdtFrameUsbTmc}.
...
Must be implemented by specific frame subclass.\par
 This method is called by the read thread.\par
 Default implementation simply stores data, and set the EOF condition to true. This way, it's possible to use \hyperlink{classmdt_frame}{mdtFrame} for raw binary transferts. 
...
Reimplemented in \hyperlink{classmdt_frame_ascii_a9ef48ef78d9603a9d8c3be7e39b03745}{mdtFrameAscii}, and \hyperlink{classmdt_frame_modbus_tcp_a0f684d77c03e5fb91598c9a10715bedb}{mdtFrameModbusTcp}.
...
This is an overloaded function. The token can be a sequence of bytes. \begin{DoxySeeAlso}{See also}
...
This is used by \hyperlink{classmdt_port_read_thread}{mdtPortReadThread} with timeout protocols. \hypertarget{classmdt_frame_abfd6de396626f01ebf972b7d6cd26957}{
...
If set true, all null values ('$\backslash$0' or 0) are not stored by \hyperlink{classmdt_frame_af03d60dadc6bd33b3a333cf484463113}{putUntil()} methods \hypertarget{classmdt_frame_a36e4b85a3c671902ac3c8cc318ca726c}{
