...
\item[\hyperlink{todo__todo000030}{Todo}]Port manager has no raison to inherit \hyperlink{class_q_thread}{Q\-Thread} -\/$>$ make it inherit \hyperlink{class_q_object}{Q\-Object} \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000031}{Todo}]Document init, open, close, ...\end{DoxyRefDesc}
...
Referenced by mdt\-Device\-::current\-State(), is\-Closed(), mdt\-Modbus\-Tcp\-Port\-Manager\-::is\-Ready(), is\-Ready(), on\-Threads\-Error\-Occured(), start(), wait\-One\-Transaction\-Done(), and wait\-Transaction\-Done().
...
\end{DoxySeeAlso}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000029}{Todo}]A méditer\-:
\begin{DoxyItemize}
\item Lock le mutex
...
Referenced by from\-Thread\-New\-Frame\-Readen(), mdt\-Modbus\-Tcp\-Port\-Manager\-::get\-Hardware\-Node\-Address(), mdt\-Device\-::get\-New\-Transaction(), mdt\-Modbus\-Tcp\-Port\-Manager\-::get\-Register\-Values(), mdt\-Modbus\-Tcp\-Port\-Manager\-::send\-Data(), send\-Data(), and mdt\-Modbus\-Tcp\-Port\-Manager\-::set\-Register\-Values().
...
Referenced by mdt\-Device\-::is\-Ready(), send\-Data(), start(), wait\-One\-Transaction\-Done(), wait\-Transaction\-Done(), and wait\-Transaction\-Possible().
...
Referenced by mdt\-Modbus\-Tcp\-Port\-Manager\-::get\-Hardware\-Node\-Address(), mdt\-Modbus\-Tcp\-Port\-Manager\-::get\-Register\-Values(), mdt\-Modbus\-Tcp\-Port\-Manager\-::set\-Register\-Values(), and mdt\-Device\-::wait\-Transaction\-Done().
...
Referenced by commit\-Frames(), flush\-Transactions\-Done(), flush\-Transactions\-Pending(), readen\-Frame(), readen\-Frames(), mdt\-Device\-::restore\-Transaction(), mdt\-Modbus\-Tcp\-Port\-Manager\-::send\-Data(), and send\-Data().
...
Reimplemented in \hyperlink{classmdt_serial_port_manager_a791572f869d1d605d0c4658ca4187260}{mdt\-Serial\-Port\-Manager}.
...
Referenced by mdt\-Device\-Modbus\-Wago\-::connect\-To\-Device(), mdt\-Device\-Modbus\-::connect\-To\-Device(), detach\-Port(), mdt\-Device\-::disconnect\-From\-Device(), mdt\-Modbus\-Tcp\-Port\-Manager\-::scan(), start(), mdt\-Device\-Modbus\-::$\sim$mdt\-Device\-Modbus(), and $\sim$mdt\-Port\-Manager().
