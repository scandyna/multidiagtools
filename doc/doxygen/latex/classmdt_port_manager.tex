...
\begin{Desc}
\item[\hyperlink{todo__todo000037}{Todo}]Port manager has no raison to inherit QThread -\/$>$ make it inherit QObject \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000038}{Todo}]Document init, open, close, ...\end{Desc}
...
\end{DoxySeeAlso}
\begin{Desc}
\item[\hyperlink{todo__todo000036}{Todo}]A méditer: \end{Desc}
-\/ Lock le mutex
\begin{DoxyItemize}
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000039}{Todo}]Should return \hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{mdtAbstractPort::error\_\-t} \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000035}{Todo}]Handle and/or display error $<$-\/ Note: no graphical dialog here ! Or.. yes ? \end{Desc}
...
Reimplemented in \hyperlink{classmdt_modbus_tcp_port_manager_a208a3b2522795974836fd8aef406725a}{mdtModbusTcpPortManager}.
