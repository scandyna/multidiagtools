...
\begin{Desc}
\item[\hyperlink{todo__todo000041}{Todo}]Port manager has no raison to inherit QThread -\/$>$ make it inherit QObject \end{Desc}
...
\begin{Desc}
\item[\hyperlink{todo__todo000042}{Todo}]Document init, open, close, ...\end{Desc}
...
\end{DoxySeeAlso}
\begin{Desc}
\item[\hyperlink{todo__todo000040}{Todo}]A méditer: \end{Desc}
-\/ Lock le mutex
\begin{DoxyItemize}
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{todo__todo000043}{Todo}]Should return \hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85e}{mdtAbstractPort::error\_\-t} \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000039}{Todo}]Handle and/or display error $<$-\/ Note: no graphical dialog here ! Or.. yes ? \end{Desc}
