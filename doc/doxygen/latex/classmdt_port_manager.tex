...
Definition at line 103 of file mdtPortManager.h.
...
Definition at line 279 of file mdtPortManager.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000014}{Todo}]Error on incomplete frame \end{Desc}
...
Definition at line 137 of file mdtPortManager.cpp.
...
\begin{Desc}
\item[\hyperlink{todo__todo000015}{Todo}]Error handling (in general ...) \end{Desc}
...
Get a copy of all currently available data. Note: the list of data must be cleared explicitly with QList::clear() after data are used. (or remove each item with, for.ex. QList::takeFirst() ) 

Reimplemented in \hyperlink{classmdt_modbus_tcp_port_manager_a6dd3c77348286dfd323ae8a1becad33c}{mdtModbusTcpPortManager}.



Definition at line 255 of file mdtPortManager.cpp.
...
Definition at line 172 of file mdtPortManager.cpp.
...
Definition at line 154 of file mdtPortManager.cpp.
...
Reimplemented in \hyperlink{classmdt_modbus_tcp_port_manager_a233d2acf67dca192fb36ce407d90bfb7}{mdtModbusTcpPortManager}, and \hyperlink{classmdt_usbtmc_port_manager_a78ec9aec17061657f2151c677fc869eb}{mdtUsbtmcPortManager}.
...
Reimplemented in \hyperlink{classmdt_modbus_tcp_port_manager_addd9b9336417aa964eea91ca2f95d26e}{mdtModbusTcpPortManager}, and \hyperlink{classmdt_usbtmc_port_manager_a7ff9a9ada7919af9a90286859695a29d}{mdtUsbtmcPortManager}.
