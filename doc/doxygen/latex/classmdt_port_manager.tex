...
\hyperlink{classmdt_port_manager_ace8065f1f5083041ee7f65c2892bc77d}{closePort()}; 
...
\begin{Desc}
\item[\hyperlink{todo__todo000005}{Todo}]FIXME: clean this ... \end{Desc}
...
config must be a valid pointer to expected a object type.void setConfig(mdtPortConfig $\ast$config);
\end{DoxyPrecond}
...
\end{DoxyPrecond}
void mdtPortManager::setConfig(mdtPortConfig $\ast$config) \{ Q\_\-ASSERT(config != 0);

pvConfig = config; \} 

Q\_\-ASSERT(pvConfig != 0); return $\ast$pvConfig; 
...
Port must have a valid configuration, and be set with \hyperlink{classmdt_port_manager_afcd156b2d0c9d340999935efb6cd8cb6}{setPort()} before calling this method
\end{DoxyPrecond}
\begin{DoxySeeAlso}{See also}
...
return pvPort-\/$>$open($\ast$pvConfig); 
...
if(pvPort-\/$>$open() != \hyperlink{classmdt_abstract_port_ad4121bb930c95887e77f8bafa065a85eab898bd273effe5cb4ed1a399a2d4baad}{mdtAbstractPort::NoError})\{ return false; \} pvPort-\/$>$close();
