...
If port was set, it returns false.\par
 If one of the threads is running, true is returned. \hypertarget{classmdt_port_manager_a4a2a146021158aeb72f9f4b6d62b6dd0}{
...
Try to open given port. If ok, the port name will be kept.\par
 \hyperlink{classmdt_abstract_port_af143cb0985d15c1c30da30cc7de206a7}{mdtAbstractPort::setAttributes()} will be called to fetch some attributes (for example available baud rates if port is a \hyperlink{classmdt_serial_port}{mdtSerialPort} object). \begin{DoxyPrecond}{Precondition}
