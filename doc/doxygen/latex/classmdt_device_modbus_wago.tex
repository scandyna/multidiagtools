...
\begin{Desc}
\item[\hyperlink{todo__todo000010}{Todo}]Handle adrress mapping of bus coupler (can be a problem with $>$ 256 I/O on 750-\/352 f.ex.) \end{Desc}


\begin{Desc}
\item[\hyperlink{todo__todo000011}{Todo}]Provisoire !!!! \end{Desc}
