...
mdtFieldMapItemDialog::mdtFieldMapItemDialog(const QWidget & parent) 
{
}
...
//For preview
void mdtFieldMapItemDialog::setDestinationData(const QString & data) 
{
}
...
void mdtFieldMapItemDialog::updateDestination Preview() 
{
}
