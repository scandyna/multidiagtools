...
/*! \brief USBTMC message for sending data to device
 *
 * For concept of USBTMC message,
 *  see USBTMC 1.0 specifications,
 *  section 3.2.1.1 and 3.3.1
 */
class mdtUsbtmcTxMessage
{
public:

  /*! \brief Construct a message that acts on given byte array
   */
  mdtUsbtmcTxMessage(const QByteArray & ba)
   : pvByteArray(ba),
     pvCursor(0)
  {
  }
 ...
 private:
  ...
  Q_DISABLE_COPY(mdtUsbtmcTxMessage);

  const QByteArray & pvByteArray;
  int pvCursor;
};

/*! \brief USBTMC message for receiving data from device
 *
 * For concept of USBTMC message,
 *  see USBTMC 1.0 specifications,
 *  section 3.2.1.1 and 3.3.1
 */
class mdtUsbtmcRxMessage
{
public:

  /*! \brief Construct a message that acts on given byte array
   */
  mdtUsbtmcRxMessage(QByteArray & ba)
   : pvByteArray(ba),
     pvCursor(0)
  {
  }
 ...
 private:
  ...
  Q_DISABLE_COPY(mdtUsbtmcRxMessage);
