...
mdtClVehicleTypeCheckBox::mdtClVehicleTypeCheckBox(QWidget *parent, const QSqlRecord &vehicleTypeData)
 : QCheckBox(parent)
{
  ...
  pvVehicleTypeId = vehicleTypeData.value("VehicleType_Id_FK");
  // Set label text
  str = type;
  if(!subType.isEmpty()){
    str += ", " + subType;
