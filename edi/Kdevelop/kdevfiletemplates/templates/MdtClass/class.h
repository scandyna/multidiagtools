...
{% include "namespace_open_cpp.txt" %}
  ...
  /*!\brief 
    */
  class {{ name }} {% if baseClasses %} : {% for b in baseClasses %}b.inheritanceMode b.baseType{% if not forloop.last %}, {% endif %}{% endfor %} {% endif %}
  {
...
{% include "namespace_close_cpp.txt" %} // {% include "namespace_open_cpp.txt" %}
