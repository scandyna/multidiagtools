...
static int  mxuport_tiocmset(struct usb_serial_port *port, struct file *file, 
...
/** NOTE: trys with 3.0.0
 * link: http://lxr.free-electrons.com/source/include/linux/usb/serial.h#L230
 */
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2,6,26))
static int mxuport_ioctl (struct usb_serial_port *port, struct file *file, unsigned int cmd, unsigned long arg);
#else
static int mxuport_ioctl (struct usb_serial_port *port, unsigned int cmd, unsigned long arg);
#endif
...
static int  mx_set_modem_info(struct usb_serial_port *port, struct file *file,
