...
#include "usbtmc.h"
/* selon: http://forum.ubuntu-fr.org/viewtopic.php?id=437664 */
...
// Called by usbtmc_ioctl... See below!
{
	...
	switch(((struct usbtmc_attribute *)arg)->attribute)
	{
		...
		case USBTMC_ATTRIB_READ_MODE:
			#ifdef USBTMC_DEBUG
			printk(KERN_NOTICE "USBTMC: Try to set read mode to %d\n", ((struct usbtmc_attribute *)arg)->value);
			#endif
			if((((struct usbtmc_attribute *)arg)->value!=
			...
			#ifdef USBTMC_DEBUG
			printk(KERN_NOTICE "USBTMC: Read mode set to %d\n", p_device_data->fread);
			#endif
			break;
...
static struct file_operations fops = {
	...
	/* .ioctl=usbtmc_ioctl, Selon: http://forum.ubuntu-fr.org/viewtopic.php?id=437664 */
