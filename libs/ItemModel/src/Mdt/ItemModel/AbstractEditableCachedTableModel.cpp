...
{
  // Get rows and transactions that must be inserted to backend
  
  // Marks those rows as intert pending (*, disabled)
  
  // Signal vertical header changed for the range of those rows
