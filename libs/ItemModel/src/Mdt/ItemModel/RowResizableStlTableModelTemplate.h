 ...
 **
 ****************************************************************************/
#ifndef MDT_ITEM_MODEL_ROW_RESIZABLE_STL_TABLE_MODEL_TEMPLATE_H
#define MDT_ITEM_MODEL_ROW_RESIZABLE_STL_TABLE_MODEL_TEMPLATE_H
...
namespace Mdt{ namespace ItemModel{
  ...
  /*! \brief Base to implement a row resizable table model for STL compliant container
   *
  ...
  class RowResizableStlTableModelTemplate : public EditableStlTableModel<Table, RecordAdapter>
  {
   public:
...
#endif // #ifndef MDT_ITEM_MODEL_ROW_RESIZABLE_STL_TABLE_MODEL_TEMPLATE_H
