 ...
 **
 ****************************************************************************/
#ifndef ABSTRACT_CACHED_TABLE_MODEL_TEST_H
#define ABSTRACT_CACHED_TABLE_MODEL_TEST_H

#include "TestBase.h"

class AbstractCachedTableModelTest : public QObject
{
 Q_OBJECT
...
#endif // #ifndef ABSTRACT_CACHED_TABLE_MODEL_TEST_H
