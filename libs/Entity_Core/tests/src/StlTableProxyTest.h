 ...
 **
 ****************************************************************************/
#ifndef STL_TABLE_PROXY_TEST_H
#define STL_TABLE_PROXY_TEST_H

#include "TestBase.h"

class StlTableProxyTest : public TestBase
{
 Q_OBJECT

 private slots:

  void iteratorDereferenceProxyTest();
...
#endif // #ifndef STL_TABLE_PROXY_TEST_H
