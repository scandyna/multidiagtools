 ...
 **
 ****************************************************************************/
#ifndef CACHED_REPOSITORY_TABLE_MODEL_TEST_H
#define CACHED_REPOSITORY_TABLE_MODEL_TEST_H

#include "TestBase.h"

class CachedRepositoryTableModelTest : public TestBase
{
 Q_OBJECT
...
#endif // #ifndef CACHED_REPOSITORY_TABLE_MODEL_TEST_H
