...
namespace Mdt{ namespace Entity{
  ...
  /*! \brief Get the field index of a field in a entity definition
   *
   * This function can be used to get the field index of a field definition
   *  in a entity definition generated by MDT_ENTITY_DEF() .
   */
  template<typename EntityDef, typename Field>
  constexpr int fieldIndex() noexcept
  {
    static_assert( TypeTraits::IsEntityDef<EntityDef>::value, "EntityDef must be a entity definition type" );
    static_assert( TypeTraits::IsEntityFieldDef<Field>::value, "Field must be a entity field definition type" );

    using first = typename boost::fusion::result_of::begin<EntityDef>::type;
    using it = typename boost::fusion::result_of::find<EntityDef, Field>::type;
