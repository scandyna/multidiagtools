...
namespace Mdt{ namespace Entity{
  ...
  void MDT_ENTITY_CORE_EXPORT printStringToConsole(const QString & str);
   ...
   */
  template<typename T>
  void MDT_ENTITY_CORE_EXPORT printEntityDataToConsole(const T & data)
  {
    printStringToConsole(QLatin1String("Entity: ") + data.def().entityName());
    boost::fusion::for_each(data.def(), PrintFieldToConsole<decltype(data.constData())>(data.constData()));
  }
