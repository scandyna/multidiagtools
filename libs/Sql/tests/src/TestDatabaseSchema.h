 ...
 **
 ****************************************************************************/
#ifndef MDT_SQL_TEST_DATABASE_SCHEMA_H
#define MDT_SQL_TEST_DATABASE_SCHEMA_H
...
class TestDatabaseSchema
{
 public:
  ...
  // Constructor (will also build schema)
  TestDatabaseSchema();
...
#endif // #ifndef MDT_SQL_TEST_DATABASE_SCHEMA_H
