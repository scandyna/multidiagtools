 ...
 **
 ****************************************************************************/
#ifndef MDT_SQL_SCHEMA_DRIVER_POSTGRESQL_H
#define MDT_SQL_SCHEMA_DRIVER_POSTGRESQL_H

#include "DriverImplementationInterface.h"

namespace Mdt{ namespace Sql{ namespace Schema{

  /*! \brief PostgreSQL schema driver
   */
  class DriverPostgreSQL : public DriverImplementationInterface
  {
   public:
...
#endif // #ifndef MDT_SQL_SCHEMA_DRIVER_POSTGRESQL_H
