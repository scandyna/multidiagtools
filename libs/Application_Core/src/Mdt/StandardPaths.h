...
namespace Mdt{
  ...
  class MDT_APPLICATION_CORE_EXPORT StandardPaths
  {
   public:
    ...
    /*! \brief Get path to the log file directory
     *
     * Returns a path to a writable location
     *  located in QStandardPaths::AppDataLocation/log
     */
     ...
     *
     * Returns a path to a writable location
     *  located in QStandardPaths::CacheLocation
     */
