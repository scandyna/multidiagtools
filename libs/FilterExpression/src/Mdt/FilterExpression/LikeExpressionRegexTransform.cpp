...
// 
//   using Mdt::Algorithm::indexOfFirstNonEscapedToken;
// 
//   LikeExpressionRegexTransformWildcardMatch wc;
// 
//   wc.index = indexOfFirstNonEscapedToken(str, from, {'?','*'}, '\\');
//   if(wc.index > -1){
//     wc.wildcard = str.at(wc.index);
//   }
// 
...
// //     if(it != last){
// //       /*
// //        * If wildcard is found at first position in str, it cannot be escaped.
// //        * Else, we must check.
// //        */
