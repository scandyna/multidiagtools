 ...
 **
 ****************************************************************************/
#ifndef MDT_QUERY_EXPRESSION_QUERY_FIELD_LIST_H
#define MDT_QUERY_EXPRESSION_QUERY_FIELD_LIST_H
...
namespace Mdt{ namespace QueryExpression{
   ...
   * \deprecated
   */
  class MDT_QUERYEXPRESSION_CORE_EXPORT QueryFieldList
  {
   public:
...
#endif // #ifndef MDT_QUERY_EXPRESSION_QUERY_FIELD_LIST_H
