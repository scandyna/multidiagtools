 ...
 **
 ****************************************************************************/
#ifndef MDT_QUERY_EXPRESSION_LIKE_EXPRESSION_REGEX_TRANSFORM_H
#define MDT_QUERY_EXPRESSION_LIKE_EXPRESSION_REGEX_TRANSFORM_H
...
namespace Mdt{ namespace QueryExpression{
   ...
   */
  class MDT_QUERYEXPRESSION_CORE_EXPORT LikeExpressionRegexTransform
  {
   public:
...
#endif // #ifndef MDT_QUERY_EXPRESSION_LIKE_EXPRESSION_REGEX_TRANSFORM_H
