...
class EditVehicleTypeClassTableModelTest : public TestBase
{
 Q_OBJECT

 public:

  EditVehicleTypeClassTableModelTest();

 private slots:

  void initTestCase();

  void insertAndSubmitAndFetchAllTest();
  void setDataAndSubmitTest();
  void removeTest();

 private:

  void setupTableModel(Mdt::Railway::EditVehicleTypeClassTableModel *model);
  bool clearStorage();
