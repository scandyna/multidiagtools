 ...
 **
 ****************************************************************************/
#ifndef MDT_RAILWAY_CHOOSE_VEHICLE_TYPE_CACHE_H
#define MDT_RAILWAY_CHOOSE_VEHICLE_TYPE_CACHE_H
...
namespace Mdt{ namespace Railway{
  ...
  /*! \brief
   */
  class MDT_RAILWAY_CORE_EXPORT ChooseVehicleTypeCache : public Mdt::Entity::AbstractAsyncReadOnlyCache
  {
   Q_OBJECT
   ...
   public:
    ...
    /*! \brief Constructor
     */
    ChooseVehicleTypeCache(QObject *parent = nullptr);
     ...
     */
    VehicleTypeId id(int row) const noexcept;
...
#endif // #ifndef MDT_RAILWAY_CHOOSE_VEHICLE_TYPE_CACHE_H
