 ...
 **
****************************************************************************/
#ifndef MDT_PLAIN_TEXT_TEST_UTILS_H
#define MDT_PLAIN_TEXT_TEST_UTILS_H
...
namespace Mdt{ namespace PlainText{
   ...
   *
   * This class can be used by a other library of Mdt.
   *  Using it outside Mdt was not tested.
   */
  class TestUtils
  {
   public:
...
namespace QTest{
                       ...
                       const char *actual, const char *expected, const char *file, int line)
  {
    ...
    if(actualSize != expectedSize){
      ...
      return Mdt::PlainText::TestUtils::compare_helper_nok(msg, nullptr, nullptr, actual, expected, file, line);
    }
    ...
    return Mdt::PlainText::TestUtils::compare_helper_ok(nullptr, nullptr, actual, expected, file, line);
  }
...
#endif // #ifndef MDT_PLAIN_TEXT_TEST_UTILS_H
