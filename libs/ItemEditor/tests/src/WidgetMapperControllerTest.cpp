...
// // Bug discovered 20170427
// void WidgetMapperControllerTest::lineEditUpdateOnNewRow()
// {
//   QLineEdit editor0;
//   /*
//    * Setup model
...
//   QVERIFY(editor0.text().isEmpty());
//   /*
//    * Repeat above test, but update model data to 0 value after insert
//    */
//   model.resize(0, 1);
//   QCOMPARE(controller.currentRow(), -1);
//   QVERIFY(editor0.text().isEmpty());
...
//   QCOMPARE(controller.currentRow(), 0);
//   QVERIFY(editor0.text().isEmpty());
//   QVERIFY(setModelData(model, 0, 0, 0));
//   QCOMPARE(editor0.text(), QString("0"));
//   editor0.setText("1");
//   QVERIFY(controller.submit());
//   QCOMPARE(editor0.text(), QString("1"));
//   /*
...
//   QCOMPARE(controller.currentRow(), 1);
//   QVERIFY(editor0.text().isEmpty());
//   QVERIFY(setModelData(model, 1, 0, 0));
//   QCOMPARE(editor0.text(), QString("0"));
//   QVERIFY(controller.submit());
//   QCOMPARE(editor0.text(), QString("0"));
//   /*
//    * Set current data to 1 then 0
//    */
//   QVERIFY(setModelData(model, 1, 0, 1));
//   QCOMPARE(editor0.text(), QString("1"));
//   QVERIFY(setModelData(model, 1, 0, 0));
//   QCOMPARE(editor0.text(), QString("0"));
// }
